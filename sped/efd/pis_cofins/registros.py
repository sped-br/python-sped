...
class RegistroC100(Registro):
    ...
    campos = [
        ...
        Campo(7, 'SER'),
        Campo(8, 'NUM_DOC', obrigatorio=True),
        Campo(9, 'CHV_NFE', obrigatorio=True),
        CampoData(10, 'DT_DOC'),
        CampoData(11, 'DT_E_S', obrigatorio=True),
        CampoNumerico(12, 'VL_DOC', obrigatorio=True, precisao=2),
        CampoNumerico(13, 'IND_PGTO', obrigatorio=True),
...
class RegistroC120(Registro):
    ...
    campos = [
        ...
        CampoNumerico(4, 'VL_PIS_IMP', precisao=2),
        CampoNumerico(5, 'VL_COFINS_IMP', precisao=2),
        Campo(6, 'NUM_ACDRAW'),
    ]
...
class RegistroC170(Registro):
    ...
    campos = [
        ...
        CampoNumerico(29, 'ALIQ_PIS_QUANT', precisao=2),
        ...
        CampoNumerico(35, 'ALIQ_COFINS_QUANT', precisao=2),
...
class RegistroC175(Registro):
    ...
    campos = [
        ...
        CampoNumerico(3, 'VL_OPR', obrigatorio=True, precisao=2),
        CampoNumerico(4, 'VL_DESC', precisao=2),
        Campo(5, 'CST_PIS'),
        CampoNumerico(6, 'VL_BC_PIS', precisao=2),
        CampoNumerico(7, 'ALIQ_PIS', precisao=2),
        Campo(8, 'QUANT_BC_PIS'),
        CampoNumerico(9, 'ALIQ_PIS_QUANT', precisao=2),
        CampoNumerico(10, 'VL_PIS', precisao=2),
        Campo(11, 'CST_COFINS', obrigatorio=True),
        CampoNumerico(12, 'VL_BC_COFINS', precisao=2),
        CampoNumerico(13, 'ALIQ_COFINS', precisao=2),
        Campo(14, 'QUANT_BC_COFINS'),
        CampoNumerico(15, 'ALIQ_COFINS_QUANT', precisao=2),
        CampoNumerico(16, 'VL_COFINS', precisao=2),
        Campo(17, 'COD_CTA'),
        Campo(18, 'INFO_COMPL'),
    ]
...
class RegistroC180(Registro):
    ...
    campos = [
        ...
        Campo(6, 'COD_NCM'),
        Campo(7, 'EX_IPI'),
        CampoNumerico(8, 'VL_TOT_ITEM', obrigatorio=True, precisao=2),
    ]
...
class RegistroC181(Registro):
    ...
    campos = [
        ...
        CampoNumerico(4, 'VL_ITEM', obrigatorio=True, precisao=2),
        CampoNumerico(5, 'VL_DESC', precisao=2),
        CampoNumerico(6, 'VL_BC_PIS', precisao=2),
        CampoNumerico(7, 'ALIQ_PIS', precisao=2),
        Campo(8, 'QUANT_BC_PIS'),
        CampoNumerico(9, 'ALIQ_PIS_QUANT', precisao=2),
...
class RegistroC185(Registro):
    ...
    campos = [
        ...
        CampoNumerico(4, 'VL_ITEM', obrigatorio=True, precisao=2),
        CampoNumerico(5, 'VL_DESC', precisao=2),
        CampoNumerico(6, 'VL_BC_COFINS', precisao=2),
        CampoNumerico(7, 'ALIQ_COFINS', precisao=2),
        Campo(8, 'QUANT_BC_COFINS'),
        CampoNumerico(9, 'ALIQ_COFINS_QUANT', precisao=2),
...
class RegistroC191(Registro):
    ...
    campos = [
        ...
        CampoNumerico(5, 'VL_ITEM', obrigatorio=True, precisao=2),
        CampoNumerico(6, 'VL_DESC', precisao=2),
        CampoNumerico(7, 'VL_BC_PIS', precisao=2),
        CampoNumerico(8, 'ALIQ_PIS', precisao=2),
        Campo(9, 'QUANT_BC_PIS'),
        CampoNumerico(10, 'ALIQ_PIS_QUANT', precisao=2),
        CampoNumerico(11, 'VL_PIS', precisao=2),
        Campo(12, 'COD_CTA'),
    ]
...
class RegistroC195(Registro):
    ...
    campos = [
        ...
        CampoNumerico(5, 'VL_ITEM', obrigatorio=True, precisao=2),
        CampoNumerico(6, 'VL_DESC', precisao=2),
        CampoNumerico(7, 'VL_BC_COFINS', precisao=2),
        CampoNumerico(8, 'ALIQ_COFINS', precisao=2),
        Campo(9, 'QUANT_BC_COFINS'),
        CampoNumerico(10, 'ALIQ_COFINS_QUANT', precisao=2),
        CampoNumerico(11, 'VL_COFINS', precisao=2),
        Campo(12, 'COD_CTA'),
    ]
...
class RegistroC500(Registro):
    ...
    campos = [
        ...
        CampoData(9, 'DT_ENT'),
        CampoNumerico(10, 'VL_DOC', obrigatorio=True, precisao=2),
        CampoNumerico(11, 'VL_ICMS', precisao=2),
        Campo(12, 'COD_INF'),
        CampoNumerico(13, 'VL_PIS', precisao=2),
        CampoNumerico(14, 'VL_COFINS', precisao=2),
    ]
...
class RegistroC501(Registro):
    ...
    campos = [
        ...
        Campo(2, 'CST_PIS', obrigatorio=True),
        CampoNumerico(3, 'VL_ITEM', obrigatorio=True, precisao=2),
        Campo(4, 'NAT_BC_CRED'),
        CampoNumerico(5, 'VL_BC_PIS', obrigatorio=True, precisao=2),
        CampoNumerico(6, 'ALIQ_PIS', obrigatorio=True, precisao=2),
        CampoNumerico(7, 'VL_PIS', obrigatorio=True, precisao=2),
        Campo(8, 'COD_CTA'),
    ]
...
class RegistroC505(Registro):
    ...
    campos = [
        ...
        CampoNumerico(3, 'VL_ITEM', obrigatorio=True, precisao=2),
        Campo(4, 'NAT_BC_CRED'),
        CampoNumerico(5, 'VL_BC_COFINS', obrigatorio=True, precisao=2),
        CampoNumerico(6, 'ALIQ_COFINS', obrigatorio=True, precisao=2),
        CampoNumerico(7, 'VL_COFINS', obrigatorio=True, precisao=2),
        Campo(8, 'COD_CTA'),
    ]
...
class RegistroM200(Registro):
    ...
    campos = [
        ...
        CampoNumerico(2, 'VL_TOT_CONT_NC_PER', obrigatorio=True, precisao=2),
        CampoNumerico(3, 'VL_TOT_CRED_DESC', obrigatorio=True, precisao=2),
        CampoNumerico(4, 'VL_TOT_CRED_DESC_ANT', obrigatorio=True, precisao=2),
        CampoNumerico(5, 'VL_TOT_CONT_NC_DEV', obrigatorio=True, precisao=2),
        CampoNumerico(6, 'VL_RET_NC', obrigatorio=True, precisao=2),
        CampoNumerico(7, 'VL_OUT_DED_NC', obrigatorio=True, precisao=2),
        CampoNumerico(8, 'VL_CONT_NC_REC', obrigatorio=True, precisao=2),
        CampoNumerico(9, 'VL_TOT_CONT_CUM_PER', obrigatorio=True, precisao=2),
        CampoNumerico(10, 'VL_RET_CUM', obrigatorio=True, precisao=2),
        CampoNumerico(11, 'VL_OUT_DED_CUM', obrigatorio=True, precisao=2),
        CampoNumerico(12, 'VL_CONT_CUM_REC', obrigatorio=True, precisao=2),
        CampoNumerico(13, 'VL_TOT_CONT_REC', obrigatorio=True, precisao=2),
    ]
...
class RegistroM205(Registro):
    ...
    campos = [
        ...
        CampoNumerico(4, 'VL_DEBITO', obrigatorio=True, precisao=2),
    ]
...
class RegistroM210(Registro):
    ...
    campos = [
        ...
        Campo(3, 'VL_REC_BRT', obrigatorio=True),
        CampoNumerico(4, 'VL_BC_CONT', obrigatorio=True, precisao=2),
        CampoNumerico(5, 'VL_AJUS_ACRES_BC_PIS', precisao=2),
        CampoNumerico(6, 'VL_AJUS_REDUC_BC_PIS', precisao=2),
        CampoNumerico(7, 'VL_BC_CONT_AJUS', precisao=2),
        CampoNumerico(8, 'ALIQ_PIS', precisao=2),
        Campo(9, 'QUANT_BC_PIS'),
        CampoNumerico(10, 'ALIQ_PIS_QUANT', precisao=2),
        CampoNumerico(11, 'VL_CONT_APUR', obrigatorio=True, precisao=2),
        CampoNumerico(12, 'VL_AJUS_ACRES', obrigatorio=True, precisao=2),
        CampoNumerico(13, 'VL_AJUS_REDUC', obrigatorio=True, precisao=2),
        CampoNumerico(14, 'VL_CONT_DIFER', precisao=2),
        CampoNumerico(15, 'VL_CONT_DIFER_ANT', precisao=2),
        CampoNumerico(16, 'VL_CONT_PER', obrigatorio=True, precisao=2),
    ]
...
class RegistroM211(Registro):
    ...
    campos = [
        ...
        CampoNumerico(3, 'VL_BC_CONT_ANT_EXC_COOP', obrigatorio=True, precisao=2),
        CampoNumerico(4, 'VL_EXC_COOP_GER', precisao=2),
        CampoNumerico(5, 'VL_EXC_ESP_COOP', precisao=2),
        CampoNumerico(6, 'VL_BC_CONT', obrigatorio=True, precisao=2),
    ]
...
class RegistroM220(Registro):
    ...
    campos = [
        ...
        Campo(2, 'IND_AJ', obrigatorio=True),
        CampoNumerico(3, 'VL_AJ', obrigatorio=True, precisao=2),
        Campo(4, 'COD_AJ', obrigatorio=True),
        Campo(5, 'NUM_DOC'),
        Campo(6, 'DESCR_AJ'),
        CampoData(7, 'DT_REF'),
...
class RegistroM230(Registro):
    ...
    campos = [
        ...
        CampoCNPJ(2, 'CNPJ', obrigatorio=True),
        CampoNumerico(3, 'VL_VEND', obrigatorio=True, precisao=2),
        CampoNumerico(4, 'VL_NAO_RECEB', obrigatorio=True, precisao=2),
        CampoNumerico(5, 'VL_CONT_DIF', obrigatorio=True, precisao=2),
        CampoNumerico(6, 'VL_CRED_DIF', precisao=2),
        Campo(7, 'COD_CRED'),
    ]
...
class RegistroM300(Registro):
    ...
    campos = [
        ...
        Campo(2, 'COD_CONT', obrigatorio=True),
        CampoNumerico(3, 'VL_CONT_APUR_DIFER', obrigatorio=True, precisao=2),
        Campo(4, 'NAT_CRED_DESC'),
        CampoNumerico(5, 'VL_CRED_DESC_DIFER', precisao=2),
        CampoNumerico(6, 'VL_CONT_DIFER_ANT', obrigatorio=True, precisao=2),
...
class RegistroM410(Registro):
    ...
    campos = [
        ...
        CampoNumerico(3, 'VL_REC', obrigatorio=True, precisao=2),
        Campo(4, 'COD_CTA', obrigatorio=True),
...
class RegistroM500(Registro):
    ...
    campos = [
        ...
        Campo(2, 'COD_CRED', obrigatorio=True),
        Campo(3, 'IND_CRED_ORI', obrigatorio=True),
        CampoNumerico(4, 'VL_BC_COFINS', precisao=2),
        CampoNumerico(5, 'ALIQ_COFINS', precisao=2),
        Campo(6, 'QUANT_BC_COFINS'),
        CampoNumerico(7, 'ALIQ_COFINS_QUANT', precisao=2),
        CampoNumerico(8, 'VL_CRED', obrigatorio=True, precisao=2),
        CampoNumerico(9, 'VL_AJUS_ACRES', obrigatorio=True, precisao=2),
        CampoNumerico(10, 'VL_AJUS_REDUC', obrigatorio=True, precisao=2),
        CampoNumerico(11, 'VL_CRED_DIFER', obrigatorio=True, precisao=2),
        CampoNumerico(12, 'VL_CRED_DISP', obrigatorio=True, precisao=2),
        Campo(13, 'IND_DESC_CRED', obrigatorio=True),
        CampoNumerico(14, 'VL_CRED_DESC', precisao=2),
        Campo(15, 'SLD_CRED', obrigatorio=True),
    ]
...
class RegistroM505(Registro):
    ...
    campos = [
        ...
        Campo(2, 'NAT_BC_CRED', obrigatorio=True),
        Campo(3, 'CST_COFINS', obrigatorio=True),
        CampoNumerico(4, 'VL_BC_COFINS_TOT', precisao=2),
        CampoNumerico(5, 'VL_BC_COFINS_CUM', precisao=2),
        CampoNumerico(6, 'VL_BC_COFINS_NC', precisao=2),
        CampoNumerico(7, 'VL_BC_COFINS', precisao=2),
...
class RegistroM610(Registro):
    ...
    campos = [
        ...
        Campo(2, 'COD_CONT', obrigatorio=True),
        CampoNumerico(3, 'VL_REC_BRT', obrigatorio=True, precisao=2),
        CampoNumerico(4, 'VL_BC_CONT', obrigatorio=True, precisao=2),
        CampoNumerico(5, 'VL_AJUS_ACRES_BC_COFINS', precisao=2),
        CampoNumerico(6, 'VL_AJUS_REDUC_BC_COFINS', precisao=2),
        CampoNumerico(7, 'VL_BC_CONT_AJUS', precisao=2),
        CampoNumerico(8, 'ALIQ_COFINS', precisao=2),
        Campo(9, 'QUANT_BC_COFINS'),
        CampoNumerico(10, 'ALIQ_COFINS_QUANT', precisao=2),
...
class RegistroM800(Registro):
    ...
    campos = [
        ...
        Campo(2, 'CST_COFINS', obrigatorio=True),
        CampoNumerico(3, 'VL_TOT_REC', obrigatorio=True, precisao=2),
        Campo(4, 'COD_CTA'),
        Campo(5, 'DESC_COMPL'),
    ]
